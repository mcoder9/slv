...
const commandStep1 = `curl -fsSL https://storage.slv.dev/slv/install | sh`
const commandStep2 = 'slv validator init'
const commandStep3 = 'slv validator deploy'

export default function SLVCommands() {
