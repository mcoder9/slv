  ...
  return (
    <>
      <div className="relative mx-auto max-w-7xl px-8 py-24 sm:px-12 md:py-60 lg:px-3">
        ...
        >
          {t('staking.Why1SOLnot1elSOLRow.title')}
        </h2>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-7">
          <div className="px-16 sm:col-span-3 sm:px-0">
            <Image
              src={Why1SOLnot1elSOLImg}
              alt={t('staking.Why1SOLnot1elSOLRow.title')}
              className="w-full"
              unoptimized
              width={256}
              height={256}
          ...
          <div className="sm:col-span-4">
            ...
            >
              {t('staking.Why1SOLnot1elSOLRow.summary')}
            </h3>
            <p
              className={cn(
            ...
            >
              {t('staking.Why1SOLnot1elSOLRow.description')}
            </p>
            <div className="flex flex-wrap items-center justify-start gap-3 pt-6">
              <Link href={DEFAULT_PATHS.staking}>
                <Button>{t('staking.Why1SOLnot1elSOLRow.button1')}</Button>
              </Link>
            </div>
          </div>
        </div>
