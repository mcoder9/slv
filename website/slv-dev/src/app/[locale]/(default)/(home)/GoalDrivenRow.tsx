import { GoalDrivenImg } from '@/assets/img'
...
export default function GoalDrivenRow() {
  ...
  return (
    <>
      <div className="relative mx-auto max-w-7xl px-8 py-24 sm:px-12 md:py-60 lg:px-3">
        ...
        >
          {t('(home).GoalDrivenRow.title')}
        </h2>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-7">
          <div className="px-16 sm:col-span-3 sm:px-0">
            <Image
              src={GoalDrivenImg}
              alt={t('(home).GoalDrivenRow.title')}
              className="w-full"
              unoptimized
              width={256}
              height={256}
          ...
          <div className="sm:col-span-4">
            ...
            >
              {t('(home).GoalDrivenRow.description')}
            </p>
